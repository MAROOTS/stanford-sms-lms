  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 gap-4 sticky top-0 z-10">
      <div className="flex items-center gap-3 flex-1">
        <button
          onClick={toggle}
          className="text-slate-500 hover:text-slate-700 p-1.5 rounded-lg hover:bg-slate-50 transition-colors lg:hidden"
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          aria-label={`Logged in as ${displayName}. Click to sign out.`}
        >
