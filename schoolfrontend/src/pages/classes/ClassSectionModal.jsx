...
export default function ClassSectionModal({ initialData, gradeLevels, teachers, onClose, onSaved, readOnly }) {
    ...
    return (
        <div className="fixed inset-0 bg-slate-900/40 flex items-center justify-center z-50 px-4" onClick={onClose}>
            <div className="bg-white rounded-xl w-full max-w-md p-6 shadow-xl animate-fade-in" onClick={(e) => e.stopPropagation()}>
                <div className="flex items-center justify-between mb-5">
                    <h2 className="text-lg font-bold text-slate-900">{isView ? 'View class' : isEdit ? 'Edit class' : 'Add class'}</h2>
