...
export default function Dashboard() {
    ...
    // Load dashboard summary and terms
    useEffect(() => {
        setError(null);
    ...
    const loadTrend = useCallback(async () => {
        ...
        try {
            ...
            setTrendError(
                readApiError(err, {
                    notFound: 'That term was not found.',
                    forbidden:
                        'You do not have access to the attendance trend.',
                    error:
                        'Could not load the attendance trend.',
                })
            );
        }
    ...
    const handleExport = () => {
        ...
        const rows = [
            ...
            [
                ...
                summary.totalStudentsChangePercent ?? ''
            ],
            [
                'Total Teachers',
                summary.totalTeachers,
                summary.totalTeachersChangePercent ?? ''
            ],
            [
                'Active Classes',
                summary.activeClasses,
                summary.activeClassesChangePercent ?? ''
            ],
            [
                'Attendance Today (%)',
                summary.attendanceToday ?? '',
                summary.attendanceTodayChangePercent ?? ''
            ],
        ];
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center justify-between mb-4">
                                    <div
                                        className={`w-11 h-11 rounded-xl bg-gradient-to-br ${gradient} flex items-center justify-center shadow-md`}
                                    >
                                        <Icon
                                            size={20}
                ...
                <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-0.5">
                            Daily average attendance across all classes
                        </p>
                    </div>
                ...
                {trendError ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-16 text-center">
                        ...
                        <p className="text-sm text-slate-400 font-medium">
                            No attendance data recorded for this period yet.
                        </p>
                    </div>
                ) : (
                    <ResponsiveContainer
