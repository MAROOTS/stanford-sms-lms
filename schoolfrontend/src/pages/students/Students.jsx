            ...
            {!loading && !error && students.length > 0 && (
                <>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:hidden">
                        {students.map((s) => (
                            <div key={s.id} className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col gap-3">
                                <div className="flex items-start justify-between gap-3">
                                    <div className="flex items-center gap-3">
                                        {s.photoUrl ? (
                                            ...
                                            <div
                                                className={`w-10 h-10 rounded-full flex items-center justify-center text-xs font-bold shadow-sm border border-black/5 ${getAvatarStyle(s.firstName)}`}
                                            >
                                                {s.firstName?.[0]}
                                                {s.lastName?.[0]}
                                            </div>
                                ...
                                {s.email && (
                                    <div className="text-xs text-slate-600 bg-slate-50 px-3 py-2 rounded-xl border border-slate-100 truncate">
                                        <span className="font-medium text-slate-400 mr-2">Email:</span>
                                        {s.email}
                                    </div>
                                )}
                                    ...
                                    {user?.role === 'ADMIN' && (
                                        <>
                                            ...
                                            <button
                                                ...
                                                className="p-2 rounded-lg text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 bg-slate-50 border border-slate-200/60 transition-colors"
                                            >
                                                <Unlock size={16} />
                                            </button>
                                            <button
                        ...
                        <div className="overflow-x-auto custom-scrollbar">
                            <table className="w-full text-sm text-left">
                                ...
                                <tr className="text-[11px] font-bold tracking-wider text-slate-500 uppercase">
                                    ...
                                    <th className="px-6 py-4 lg:table-cell">Email</th>
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 lg:table-cell">
                                                <span className="text-slate-600 font-medium">
                                                    {s.email || <span className="text-slate-400 italic font-normal">No email</span>}
                                                </span>
                                        </td>
                                        <td className="px-6 py-4">
                                            {s.classSectionName ? (
